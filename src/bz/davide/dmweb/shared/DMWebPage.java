...
{
   String                     title       = "";
   DMWidget[]                 bodyContent = new DMWidget[0];
   ArrayList<DMAttachHandler> domReady    = new ArrayList<DMAttachHandler>();
   ...
   public void setBodyContent(DMWidget[] bodyContent)
   {
   ...
   public DMWidget[] getBodyContent()
   {
