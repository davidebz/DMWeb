 ...
 */
public class DMLeafletMapAttachHandler implements DMAttachHandler
{
   DMLeafletMap mapWidget;

   public DMLeafletMapAttachHandler(DMLeafletMap mapWidget)
   {
      super();
      this.mapWidget = mapWidget;
   }

   protected DMLeafletMapAttachHandler(Void void1)
   {
   }
